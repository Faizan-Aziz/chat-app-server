...
const io= new Server(server,{
  cors:{
     origin: ['http://localhost:5173', 'https://localhost:5173' , 'http://192.168.0.106:5173'],
     methods:['GET' , 'POST'],
    credentials: true
  }
})
...
app.use(cors({
  origin: ['http://localhost:5173', 'https://localhost:5173' ,  'http://192.168.0.106:5173'], // 🛡️ ONLY this frontend can access
